...
#' @param type Character. This indicated the type of Sums of Squares from which the omega-squared statistic should be calculated. Options are digits from 1 to 3 and the corresponding roman numerals. Defaults to type 1.
#'
...
omega_sq <- function(aov_in, type = "1"){
